# TABLEAU-PROJECT
# 📉 HR Attrition Drivers Dashboard (Tableau Analysis)

## Project Overview

This repository features a comprehensive **HR Attrition Rate Analysis Dashboard** built using **Tableau**. 
The project’s objective is to identify and analyze the primary structural drivers of employee turnover, moving beyond surface-level reporting to guide strategic, data-driven interventions.
...
The analysis identified three primary structural drivers that contribute to the highest risk of employee attrition (as detailed in the slide deck):

1.  **Mid-Career Male Employees (Age 26-35):** This specific age and gender cohort shows a significantly elevated turnover rate, indicating potential dissatisfaction with current compensation, career growth opportunities, or higher external market demand.

2.  **Low-Tenure Employees (< 2 Years):** The attrition rate for new hires is disproportionately high, suggesting potential weaknesses in the initial phases of employment, such as onboarding, training, or job-role alignment.
...
* **Attrition by Gender & Age Group:** Visual segmentation of turnover risk across critical demographics.
...
The following strategies are recommended based on the data to mitigate the identified risks:
